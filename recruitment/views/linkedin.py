...
def check_linkedin(request):
    ...
    data = {
        ...
        "code": request.GET.get("code") or os.environ.get("LINKEDIN_AUTH_CODE", ""),
...
def post_recruitment_in_linkedin(
    ...
    # Use Geekonomy Favicon Logo as thumbnail
    thumbnail_url = request.build_absolute_uri("/static/images/ui/Geekonomy Favicon Logo.png")
