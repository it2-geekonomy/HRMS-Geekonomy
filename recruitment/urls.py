...
urlpatterns = [
    ...
    path("candidate-stage-select/<int:cand_id>/", views.candidate_stage_select, name="candidate-stage-select"),
    path("candidate-stage-change-modal/", views.candidate_stage_change_modal, name="candidate-stage-change-modal"),
    ...
    path(
        "candidate-resume/<int:cand_id>/",
        views.candidate_resume_file,
        name="candidate-resume-file",
    ),
    path(
        "candidate-resume-viewer/<int:cand_id>/",
        views.candidate_resume_viewer,
        name="candidate-resume-viewer",
    ),
    path(
    ...
    path(
        "candidate-revert-conversion/<int:cand_id>/",
        views.candidate_revert_conversion,
        name="candidate-revert-conversion",
        kwargs={"model": Candidate},
    ),
    path(
    ...
    path(
        "application-success/",
        recruitment.views.surveys.application_success,
    ...
    path(
        ...
        recruitment.views.surveys.survey_preview,
        name="survey-template-preview-by-id",
    ),
    path(
