...
urlpatterns = [
    ...
    path(
        ...
        views.view_document_templates,
        name="view-document-templates",
    ),
    path(
        "view-document-template/<int:obj_id>/",
        views.view_document_template,
    ...
    path(
        "duplicate-document-template/<int:obj_id>/",
        views.object_duplicate,
        name="duplicate-document-template",
        kwargs={
            "model": DocumentTemplate,
            "form": DocumentTemplateForm,
            "template": "base/document_templates/htmx/form.html",
        },
    ),
    path(
        "delete-document-template/",
        views.delete_document_templates,
        name="delete-document-template",
    ),
    path(
        "configuration/document-templates/generate/",
    ...
    path("my-leave-summary/", views.my_leave_summary, name="my-leave-summary"),
    path("my-hours-summary/", views.my_hours_summary, name="my-hours-summary"),
]
