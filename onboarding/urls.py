...
urlpatterns = [
    ...
    path(
        "checklist-step/<int:progress_id>/",
        views.onboarding_checklist_step_toggle,
        name="onboarding-checklist-step-toggle",
    ),
    path(
        "checklist-logs/<int:progress_id>/",
        views.onboarding_checklist_logs,
        name="onboarding-checklist-logs",
    ),
    path(
        "checklist-upload/<int:progress_id>/",
        views.onboarding_checklist_upload,
        name="onboarding-checklist-upload",
    ),
    path(
        "archive-progress/<int:progress_id>/",
        views.onboarding_archive_progress,
        name="onboarding-archive-progress",
    ),
