...
urlpatterns = [
    ...
    path(
        "move-offboarding-stage-up",
        views.move_stage_up,
        name="move-offboarding-stage-up",
    ),
    path(
        "move-offboarding-stage-down",
        views.move_stage_down,
        name="move-offboarding-stage-down",
    ),
    path(
        "reorder-offboarding-stage",
        views.reorder_stage,
        name="reorder-offboarding-stage",
    ),
    path(
