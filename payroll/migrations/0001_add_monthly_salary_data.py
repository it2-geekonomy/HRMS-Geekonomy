    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('based_on', models.CharField(blank=True, choices=[('basic_pay', 'Basic Pay'), ('children', 'Children'), ('special_allowance', 'Special Allowance (Total Salary - Basic - HRA - Conveyance - Medical)'), ('overtime', 'Overtime'), ('shift_id', 'Shift'), ('work_type_id', 'Work Type'), ('attendance', 'Attendance')], default='basic_pay', help_text='If the allowance is not fixed then specifies how the allowance provided', max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('days_worked', models.FloatField(default=0, help_text='Count of P (Present) + L (Paid Leave) from attendance calendar', verbose_name='Days Worked')),
                ('working_days', models.IntegerField(default=0, help_text='Total days in month excluding PH and WO', verbose_name='Working Days')),
                ('basic_salary', models.FloatField(blank=True, default=0, null=True, verbose_name='Basic Salary')),
                ('monthly_salary', models.FloatField(default=0, help_text='Basic salary × 2', verbose_name='Monthly Salary')),
                ('calculated_salary', models.FloatField(default=0, verbose_name='Calculated Salary')),
                ('created_by', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='Created By')),
                ('employee_id', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='monthly_salary_data_set', to='employee.employee', verbose_name='Employee')),
                ('modified_by', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_modified_by', to=settings.AUTH_USER_MODEL, verbose_name='Modified By')),
            ],
            options={
