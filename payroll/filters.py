...
class ExpenseFilter(FilterSet):
    ...
    expense_date_till = django_filters.DateFilter(
        field_name="expense_date",
        lookup_expr="lte",
        widget=forms.DateInput(attrs={"type": "date"}),
    )
    ...
    class Meta:
        ...
        fields = [
            ...
            "mode_of_payment",
            "expense_date",
            "added_by__employee_work_info__department_id",
            "added_by__employee_work_info__job_position_id",
            "added_by__employee_work_info__reporting_manager_id",
        ]
    ...
    def filter_by_search(self, queryset, _, value):
        ...
        return queryset.filter(
            ...
            | Q(added_by__employee_first_name__icontains=value)
            | Q(added_by__employee_last_name__icontains=value)
        )
