...
urlpatterns = [
    ...
    path(
        "salary-data/",
        views.view_salary_data,
        name="view-salary-data",
    ),
    path(
        "salary-data/activity-log/",
        views.view_salary_data_audit_log,
        name="view-salary-data-audit-log",
    ),
    path(
        "salary-data/archive-month/",
        views.archive_salary_data_month,
        name="archive-salary-data-month",
    ),
    path(
        "salary-data/generate/",
        views.generate_salary_data,
        name="generate-salary-data",
    ),
    path(
        "salary-data/generate-form/",
        views.generate_salary_data_form,
        name="generate-salary-data-form",
    ),
    path(
        "salary-data/<int:salary_data_id>/",
        views.view_salary_data_detail,
        name="view-salary-data-detail",
    ),
    path(
        "salary-data/edit/<int:salary_data_id>/",
        views.edit_salary_data,
        name="edit-salary-data",
    ),
    path(
        "salary-data/delete/<int:salary_data_id>/",
        views.delete_salary_data,
        name="delete-salary-data",
    ),
    path(
        "salary-data/bulk-delete/",
        views.bulk_delete_salary_data,
        name="salary-data-bulk-delete",
    ),
    path(
        "salary-data/arrears/<int:salary_data_id>/",
        views.update_salary_data_arrears,
        name="update-salary-data-arrears",
    ),
    path(
        "salary-data/arrears-log/<int:salary_data_id>/",
        views.salary_data_arrears_log,
        name="salary-data-arrears-log",
    ),
    path(
        "salary-data/export-pdf/",
        views.export_salary_data_pdf,
        name="export-salary-data-pdf",
    ),
    path(
        "salary-data/export-excel/",
        views.export_salary_data_excel,
        name="export-salary-data-excel",
    ),
    path(
    ...
    path(
        ...
        path(
            ...
            views.employee_payroll_summary,
            name="employee-payroll-summary",
        ),
        path(
            "employee-overview/<int:employee_id>/",
            views.employee_overview,
            name="employee-overview",
        ),
        path(
            "employee-leave-attendance/<int:employee_id>/",
            views.employee_leave_attendance,
            name="employee-leave-attendance",
        ),
        path(
            "employee-payslip-breakdown/<int:employee_id>/",
            views.employee_payslip_breakdown,
            name="employee-payslip-breakdown",
        ),
        path(
            "employee-month-details/",
            views.employee_month_details,
            name="employee-month-details",
        ),
]
