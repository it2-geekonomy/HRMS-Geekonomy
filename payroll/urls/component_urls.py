...
urlpatterns = [
    ...
    path("view-expense/", component_views.view_expense, name="view-expense"),
    path("create-expense", component_views.create_expense, name="create-expense"),
    path("filter-expense", component_views.filter_expense, name="filter-expense"),
    path(
        "single-expense-view/<int:expense_id>",
        component_views.view_single_expense,
        name="single-expense-view",
    ),
    path(
        "update-expense/<int:expense_id>/",
        component_views.update_expense,
        name="update-expense",
    ),
    path(
        "archive-expense/<int:expense_id>/",
        component_views.archive_expense,
        name="archive-expense",
    ),
    path(
        "archive-expense-month/",
        component_views.archive_expense_month,
        name="archive-expense-month",
    ),
    path(
        "duplicate-expense/<int:expense_id>/",
        component_views.duplicate_expense,
        name="duplicate-expense",
    ),
    path(
        "export-expense-excel/",
        component_views.export_expense_excel,
        name="export-expense-excel",
    ),
    path(
        "export-expense-receipts-zip/",
        component_views.export_expense_receipts_zip,
        name="export-expense-receipts-zip",
    ),
]
