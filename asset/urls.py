...
urlpatterns = [
    ...
    path(
        "asset-allocation-delete/<int:allocation_id>/",
        views.asset_allocation_delete,
        name="asset-allocation-delete",
    ),
    path(
    ...
    path(
        ...
        views.asset_dashboard_card_modal,
        name="asset-dashboard-card-modal",
    ),
    path(
