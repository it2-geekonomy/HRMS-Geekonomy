...
INSTALLED_APPS.append("spring_verification")
...
SIDEBARS = [
    ...
    "leave",
    "payroll",
    # "pms",  # Performance - commented out for now, not needed
    "offboarding",
    "spring_verification",
    "asset",
    # "helpdesk",  # Help Desk - removed from sidebar
    # "project",  # Project - commented out for now, not needed
    "report",
]
