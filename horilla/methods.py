...
def get_horilla_model_class(app_label, model):
    ...
    Returns:
        ...
        or None if not found or multiple ContentTypes exist (DB inconsistency).

    """
    # Use filter().first() to avoid MultipleObjectsReturned when duplicate ContentTypes exist
