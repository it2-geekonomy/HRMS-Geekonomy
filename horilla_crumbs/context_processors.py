    ...
    try:
        ...
        for i, item in enumerate(parts):
            if skip_next:
                skip_next = False
                continue
            # Onboarding: single landing page – show "HRMS > Onboarding" not "HRMS > onboarding > onboarding-view"
            if item == "onboarding" and i + 1 < len(parts) and parts[i + 1] == "onboarding-view":
                path = path + "onboarding/onboarding-view/"
                ...
                try:
                    ...
                    found = False
                new_dict = {"url": path, "name": "Onboarding", "found": found}
                skip_next = True
