...
class HorillaMultiSelectWidget(forms.Widget):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.show_filter_dropdown = show_filter_dropdown
        super().__init__()
    ...
    def get_context(self, name, value, attrs):
        ...
        # Widget helpers for templates/JS customization
        try:
            model = getattr(queryset, "model", None)
            context["widget_model_label"] = (
                model._meta.label_lower if model is not None else ""
            )
            context["widget_has_is_active"] = (
                model is not None and any(f.name == "is_active" for f in model._meta.fields)
            )
        except Exception:
            context["widget_model_label"] = ""
            context["widget_has_is_active"] = False
        ...
        context["widget_show_filter_dropdown"] = self.show_filter_dropdown
