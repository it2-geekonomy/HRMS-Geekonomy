...
from . import comp_off_views, models, views
...
urlpatterns = [
    ...
    path(
        "dashboard-card-modal/<str:card_type>/",
        views.leave_dashboard_card_modal,
        name="leave-dashboard-card-modal",
    ),
    ...
    path(
        "leave-configuration/",
        views.leave_configuration_view,
        name="leave-configuration",
    ),
    path(
        "leave-configuration-export-excel/",
        views.export_leave_configuration_excel,
        name="leave-configuration-export-excel",
    ),
    path(
        "my-comp-off-request-view/",
        comp_off_views.my_comp_off_request_view,
        name="my-comp-off-request-view",
    ),
    path(
        "my-comp-off-request-filter",
        comp_off_views.my_comp_off_request_filter,
        name="my-comp-off-request-filter",
    ),
    path(
        "comp-off-request-view/",
        comp_off_views.comp_off_request_view,
        name="comp-off-request-view",
    ),
    path(
        "comp-off-request-filter",
        comp_off_views.comp_off_request_filter,
        name="comp-off-request-filter",
    ),
    path(
        "comp-off-request-create",
        comp_off_views.comp_off_request_create,
        name="comp-off-request-create",
    ),
    path(
        "comp-off-request-update/<int:req_id>",
        comp_off_views.comp_off_request_update,
        name="comp-off-request-update",
    ),
    path(
        "comp-off-request-delete/<int:req_id>",
        comp_off_views.comp_off_request_delete,
        name="comp-off-request-delete",
    ),
    path(
        "comp-off-request-approve/<int:req_id>",
        comp_off_views.comp_off_request_approve,
        name="comp-off-request-approve",
    ),
    path(
        "comp-off-request-reject/<int:req_id>",
        comp_off_views.comp_off_request_reject,
        name="comp-off-request-reject",
    ),
    path(
        "comp-off-request-cancel/<int:req_id>",
        comp_off_views.comp_off_request_cancel,
        name="comp-off-request-cancel",
    ),
    path(
        "comp-off-request-single-view/<int:req_id>",
        comp_off_views.comp_off_request_single_view,
        name="comp-off-request-single-view",
    ),
]
