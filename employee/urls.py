...
urlpatterns = [
    ...
    path("probation-employees/", views.probation_employees_view, name="probation-employees-view"),
    path(
        "probation-employees/confirm/<int:emp_id>/",
        views.probation_confirm,
        name="probation-confirm",
    ),
    path(
        "probation-employees/extend/<int:emp_id>/",
        views.probation_extend,
        name="probation-extend",
    ),
    path(
        "probation-employees/reject/<int:emp_id>/",
    ...
    path("joining-month-count", views.joining_month_count, name="joining-month-count"),
    path("joining-month-popup", views.joining_month_popup, name="joining-month-popup"),
    path(
        "total-strength-popup",
        views.total_strength_popup,
        name="total-strength-popup",
    ),
    ...
    path(
        "employee-get-attendance-log",
        views.employee_get_attendance_log,
        name="employee-get-attendance-log",
    ),
    path(
        "get-manage-in",
    ...
    path("team-view/", views.team_view, name="team-view"),
    ...
    path("get-teams-by-department/", views.get_teams_by_department, name="get-teams-by-department"),
]
