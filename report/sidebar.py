...
# # Performance report - removed from sidebar
...
#             "redirect": reverse_lazy("offboarding-report"),
#         }
#     )
...
def menu_accessibility(request, submenu, user_perms, *args, **kwargs):
    return (
        ...
        or request.user.has_perm("offboarding.view_resignationletter")
        or request.user.has_perm("offboarding.view_offboarding")
    )
...
def offboarding_accessibility(request, submenu, user_perms, *args, **kwargs):
    return (
        request.user.is_superuser
        or request.user.has_perm("offboarding.view_resignationletter")
        or request.user.has_perm("offboarding.view_offboarding")
