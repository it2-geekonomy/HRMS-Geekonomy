...
urlpatterns = [
    ...
    path(
        "late-come-early-out-mail/<int:attendance_id>/",
        views.late_come_early_out_mail_form,
        name="late-come-early-out-mail",
    ),
    path(
        "late-come-early-out-send-mail/<int:attendance_id>/",
        views.late_come_early_out_send_mail,
        name="late-come-early-out-send-mail",
    ),
    path(
    ...
    path(
        ...
        attendance.views.dashboard.dashboard_card_modal_content,
        name="dashboard-card-modal",
    ),
    path(
        "on-break-employees",
    ...
    path(
        "request-attendance-export-form/",
        attendance.views.requests.request_attendance_export,
        name="request-attendance-export-form",
    ),
    path(
        "request-attendance-export/",
        attendance.views.requests.request_attendance_export,
        name="request-attendance-export",
    ),
    path(
        "attendance-request-logs/",
        attendance.views.requests.attendance_request_logs_view,
        name="attendance-request-logs",
    ),
    path(
    ...
    path(
        "work-record-export-pdf/",
        views.work_record_export_pdf,
        name="work-record-export-pdf",
    ),
    path(
    ...
    path("my-work-records/", views.my_work_records, name="my-work-records"),
    path(
        "my-work-records-change-month",
        views.my_work_records_change_month,
        name="my-work-records-change-month",
    ),
    ...
    path(
        ...
        views.sync_biometric_attendance_view,
        name="sync-biometric-attendance",
    ),
    path(
        "full-sync-biometric-attendance/",
        views.full_biometric_attendance_sync_view,
        name="full-sync-biometric-attendance",
    ),
]
